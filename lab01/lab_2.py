...
problem = {
    ...
    #  Excercise 1.2a   
    "start1": ["space on c", "c on a", "a on table", "b on table", "space on table"],
    "finish1": ["space on a", "a on table", "b on table", "c on table", "space on table"],
    # Excercise 1.2b
    "start2": ["space on c", "space on a", "space on b", "a on table","c on table", "b on table", "space on table"],
    "finish2": ["c on table",  "b on c","a on b","space on a","space on table"],
    "ops": [
        {
